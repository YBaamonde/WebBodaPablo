...
(function () {
  ...
  // Genera los slides a partir del array importado
  IMAGES.forEach((entry, i) => {
    ...
    slide.innerHTML = `<img src="${IMAGE_PATH}${file}" alt="Foto ${i + 1}" loading="lazy" style="object-position: ${position}" />`;
...
if (headerContent && headerEl) {
    headerContent.style.transition = 'opacity 0.15s ease';

    window.addEventListener('scroll', () => {
        const threshold = headerEl.offsetHeight * 0.25; // empieza a desvanecerse muy pronto
